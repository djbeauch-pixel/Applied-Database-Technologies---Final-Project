...
CREATE TABLE hands (
    ...
    site_hand_id BIGINT NOT NULL, # Values exceed 16 billion upon review, Unique for each site
    ...
    tble_name VARCHAR (50), # Sometimes there can be long, interesting table names
